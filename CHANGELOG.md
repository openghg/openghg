...
- Added ability to process CRF data as flux_timeseries datatype(one dimensional data), added parser for crf too. [PR #870](https://github.com/openghg/openghg/pull/870)
