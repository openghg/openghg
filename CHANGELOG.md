...
- Added minimum version of `xarray` of 2025.04.0 due to changes put in within PR #1417 (use of `AlignmentError` from `xarray` package). [PR #1440](https://github.com/openghg/openghg/pull/1440)
