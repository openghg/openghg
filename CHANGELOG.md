...
- The `platform` keyword can be specified within the `standardise_surface` function to indicate the type of data (e.g. "surface-insitu", "surface-flask"). [PR #1276](https://github.com/openghg/openghg/pull/1276)
