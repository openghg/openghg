...
### Added
- environment-dev.yaml file added for cloud, especially dependencies like pytest, pytest-mock requested by users. - [PR #769](https://github.com/openghg/openghg/pull/769)
