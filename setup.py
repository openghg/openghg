...
setuptools.setup(
    ...
    name="openghg",
    author="Prasad Sutar, Brendan murphy, Rachel Tunnicliffe Gareth Jones",
    author_email="prasad.sutar@bristol.ac.uk, brendan.murphy@bristol.ac.uk, rachel.tunnicliffe@bristol.ac.uk",
