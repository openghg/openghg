...
def test_to_data():
    ...
    NOAA.read_file(data_filepath=filepath, species="CO")
    ...
    assert data["file_hashes"] == {
        "48ba8d093008359d836b3928bf4c9793fa564fee": "co_pocn25_surface-flask_1_ccgg_event.txt"
    }
...
def test_from_data():
    ...
    assert noaa_2._stored is False
...
def test_read_file():
    ...
    netcdf_attrs = {
        ...
        "species": "co",
        "Calibration_scale": "WMO CO_X2014A",
        "station_longitude": 0.036995,
        "station_latitude": 51.496769,
        "station_long_name": "Thames Barrier, London, UK",
    ...
    assert co_ds._data[date_key].time[0] == pd.Timestamp(
        "2017-03-25T02:00:00.000000000"
    )
    ...
    assert (
        noaa._file_hashes["48ba8d093008359d836b3928bf4c9793fa564fee"]
