...
def data_read():
    ...
    standardiser.standardise("surface", filepath=bsd_paths, source_format="CRDS", site="bsd", network=network)
    ...
    standardiser.standardise("surface", filepath=hfd_paths, source_format="CRDS", site="hfd", network=network)

    tac_path = get_surface_datapath(filename="tac.picarro.1minute.100m.test.dat", source_format="CRDS")
    standardiser.standardise("surface", filepath=tac_path, source_format="CRDS", site="tac", network=network)
    ...
    standardiser.standardise("surface",
    ...
    standardiser.standardise("column",
    ...
    source = "gpp-cardamom"
    domain = "europe"
    standardiser.standardise("emissions",
    ...
    standardiser.standardise("footprints",
                             filepath=datapath,
                             site=site,
                             model=model,
                             network=network,
    ...
    standardiser.standardise("boundary_conditions",
    ...
    standardiser.standardise("eulerian_model", filepath=test_datapath, model="GEOSChem", species="ch4")
