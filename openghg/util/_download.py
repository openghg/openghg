...
# def download_data_no_progress(
#     url: str, filepath: Optional[Union[str, Path]] = None, timeout: int = 5
# ) -> Optional[bytes]:
...
def download_data(url: str, filepath: Optional[Union[str, Path]] = None) -> Optional[bytes]:
